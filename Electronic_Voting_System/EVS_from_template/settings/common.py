# -*- coding: utf-8 -*-
"""
Django settings for EVS_from_template project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            str(ROOT_DIR.path('users/templates/_items')),
            str(ROOT_DIR.path('Voting/templates/Voting')),
        ],
        'OPTIONS': {
...
# URL Configuration
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'EVS_from_template.urls'

# See: https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = 'EVS_from_template.wsgi.application'
...
AUTH_USER_MODEL = 'users.Person'
    #'EVS_from_template.Voting.models.VotingEvent'  # subject to test
